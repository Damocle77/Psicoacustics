...
|------------|-------------|
| `sonar` | Surround con virtual upfiring AtmosX-style (SL +2.8 / SR +2.8 dB) |
| `clean` | Surround neutro, senza upfiring (SL +2.3 / SR +2.3 dB) |
...
1. Traccia 1 — Sonar: SL +2.8 dB / SR +2.8 dB
2. Traccia 2 — Clean: SL +2.3 dB / SR +2.3 dB
...
| Surround boost | Sonar SL +2.8 / SR +2.8 dB · Clean SL +2.3 / SR +2.3 dB | Ampiezza controllata |
