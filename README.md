...
|--------|--------------|----------------|
| **`convert_2ac3_sonar.sh`** | Versione unificata (v0.88) con LFE passthrough, voce +1.5 dB e surround 3D upfiring realistico | Compatibile con pipeline ffMediaMaster, include supporto batch |
